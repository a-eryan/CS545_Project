...
export default function CourseTable() {
  ...
  return (
    <div className="overflow-x-auto p-4 text-[var(--color-main-text)]">
      ...
      <table className="min-w-full border border-[var(--color-primary)]">
        <thead className="bg-[var(--color-primary)] text-[var(--color-accent)]">
          <tr>
            {[
              ...
              <th
                key={header}
                className="text-left p-2 border border-[var(--color-primary)] font-semibold"
              >
                {header}
              </th>
            ))}
        ...
        <tbody>
          {myCourses.map((course, idx) => (
            <tr key={idx} className="border border-[var(--color-primary)]">
              <td className="p-2 border border-[var(--color-primary)]">
                {course.course}
              </td>
              <td className="p-2 border border-[var(--color-primary)]">
                {course.units}
              ...
              <td className="p-2 border border-[var(--color-primary)] whitespace-pre-wrap">
              ...
              <td className="p-2 border border-[var(--color-primary)] text-center">
